...
import FlowerDesktop from "../components/flowerDesktop";
    ...
    <div>
      ...
      <Head>
        ...
        <meta
          ...
          content="Checkout my flower on map4citizens!"
        />
      ...
      {/* Display the image */}
      {/* <FlowerImage src={image_signed_url} /> */}

      <Grid
        data={[
          {
            mobileContent: <h1>Mobile Content 2</h1>,
            content: <FlowerDesktop />,
          },
          {
            mobileContent: <h1>Mobile Content 1</h1>,
            content: <FlowerImage src={image_signed_url} />,
          },
        ]}
      />
    </div>
